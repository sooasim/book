...
| **OneClick eBook Studio (제품 셸)** | [`apps/studio_api/`](apps/studio_api/) · [`apps/studio_web/`](apps/studio_web/) | **API 엔진 배선·테스트 7개 통과** | FastAPI + Next.js 스튜디오를 엔진에 연결(`oneclick-ebook-studio` 통합) |
